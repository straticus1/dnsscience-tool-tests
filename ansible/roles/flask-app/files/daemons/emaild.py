...
Monitors MX, DKIM, SPF, DMARC, SenderID, and TLS
"""
...
class EmailDaemon(BaseDaemon):
                ...
                try:
                    ...
                    cursor.execute("""
                        ...
                        (domain_id, last_checked,
                         ...
                         has_sender_id, sender_id_record)
                        ...
                        SET last_checked = EXCLUDED.last_checked,
                            ...
                            has_sender_id = EXCLUDED.has_sender_id,
                            sender_id_record = EXCLUDED.sender_id_record
                    """, (
                        ...
                        email_security['has_sender_id'], email_security['sender_id_record']
                    ))
    ...
    def check_email_security(self, domain_name):
        ...
        if found_selectors:
            ...
            result['dkim_selectors'] = ','.join(found_selectors)
